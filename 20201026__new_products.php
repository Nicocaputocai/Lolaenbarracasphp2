              ...
              <div class="product-variation">
                <form action="#" method="post">
                  <div class="cart-plus-minus">
                    ...
                    <?php if($price > '0.00'){?><a  href="#" onclick="buy();"><button href="#" class="button pro-add-to-cart" title="Agregar al carrito" type="button"><span><i class="fa fa-shopping-cart"></i> Hacé tu pedido</span></button></a><?php } ?>
