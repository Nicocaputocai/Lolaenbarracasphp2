...
class Image implements \ArrayAccess
{
    ...
    private $error_messages = array(
		...
		'mime_type'                 => "El formato del archivo no es válido! Solo se permiten formatos %s",
		'file_size'                 => "El tamaño de la imagen debe ser mínimo min: %s menos que max: %s kb",
		...
		'unknown'                   => "Ocurrió un error y no se pudo subir la imagen"
	);
