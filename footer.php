    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-12 col-lg-4">
          ...
          <p>Avda. Montes de Oca 774. Tel:+5411 4301-0227.</p>
		  <p>Avda. Montes de Oca 1013. Tel:+5411 4301-6715.</p>
		  <p>Horarios: Lunes a Sábados de 10 a 20hs.</p>
		  <p>Outlet: Avda. Montes de Oca 784 Local 3</p> 
		  <p>Tel:(5411) 4303-0013 - Galería Paseo Barracas.</p>
		  <p>Horarios: Lunes a viernes 14 a 20 hs.</p>
		  <p>Sábados de 10 a 14 hs.</p>
		  <p>Barracas - CABA - Argentina.</p>
          <div class="payment">
            <ul>
              <li><img title="Trabajamos con Mercado Pago" alt="Visa" src="/images/mercado.png" ></a></li>
        ...
        <!--<div class="col-sm-6 col-md-3 col-xs-12 col-lg-2 collapsed-block">
          <div class="footer-links">
            ...
            <div class="tabBlock" id="TabBlock-2">
              <ul class="list-links list-unstyled">
                <li><a href="/productos/all/?type=RE">Calzado</a></li>
        ...
        <div class="col-sm-6 col-md-3 col-xs-12 col-lg-2 collapsed-block">
          <div class="footer-links">
            ...
            <div class="tabBlock" id="TabBlock-4">
              <ul class="list-links list-unstyled">
                <li> <a href="/cart.php">Pagá desde nuestro sitio web con Mercado Pago</a> </li>
                <li><img title="Pagácon código QR de Mercado Pago" alt="Visa" src="/images/mercado.png" ></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
		  ...
		  <div class="social col-sm-6 col-xs-12">
            <ul class="inline-mode">
              <li class="social-network fb"><a title="Facebook" target="_blank" href="https://www.facebook.com/lolaenbarracas"><i class="fa fa-facebook"></i></a></li>
              <!--<li class="social-network googleplus"><a title="Connect us on Google+" target="_blank" href="https://plus.google.com"><i class="fa fa-google-plus"></i></a></li>-->
              <li class="social-network instagram"><a title="Instagram" target="_blank" href="https://www.instagram.com/lolaenbarracas"><i class="fa fa-instagram"></i></a></li>
			  <li class="social-network wa"><a title="Whatsapp al +5411 6157-3683" ><i class="fa fa-whatsapp"></i></a></li>
