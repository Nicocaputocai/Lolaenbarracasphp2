...
//          $('#productImageBox').html('');
       ...
       <label><p>Colores</p></label>
        ...
        <tr>
            ...
            $mitad = sizeof($colors) / 2;

            if ($colors){
                $contador = 1;
                foreach ($colors as $color)
                 {
                     if ($contador < $mitad || $contador > $mitad){
                         ?>
                         <td text-aling="center">
                             <img src="/images/colors/<?= $color['picture']; ?>" title="<?php echo $color["desc"]; ?>" style="border: 1px solid black;">
                             <input class="color_checkbox" title="<?php echo $color["desc"]; ?>" type="checkbox" value="<?php echo $color['id']; ?>" id="<?php echo $color['id']; ?>" name="colors" >
                         </td>
                         <?php
                     }
                     if ($contador == $mitad){
    ...
    <br>
<p><input class="" onchange="checkAllShoesWaists();"  type="checkbox" id="checkAllShoesW" name="checkAllWomenW"> Seleccionar todos los talles de Canzado</p>
<p><input class="" onchange="checkAllClothesWaists();"  type="checkbox" id="checkAllClothesnW" name="checkAllWomenW"> Seleccionar todos los talles de Prendas</p>
...
<!--    <p><input class="" onchange="checkAllWomenWaists();"  type="checkbox" id="checkAllWomenW" name="checkAllWomenW"> Seleccionar todos los talles de Mujer</p>
    ...
    <table class="marginTable">
        ...
        <tr><td colspan="5">Talles de Calzado</td></tr>
        <tr>
        <td>&nbsp;&nbsp;35</td>
        <td>&nbsp;&nbsp;36</td>
        <td>&nbsp;&nbsp;37</td>
        ...
        <td>       <input class="waists_checkbox" type="checkbox" value="23" id="w23" name="waists"> </td>
        <td>       <input class="waists_checkbox" type="checkbox" value="24" id="w24" name="waists"> </td>
        </tr>
    </table>
    <br>
    <table class="marginTable">
